...
import { renderRouteAwareHtml } from "../seo";
...
export function serveStatic(app: Express) {
  ...
  // Deliver unique server-side metadata, structured data, and meaningful fallback
  // HTML for every application route instead of returning a metadata-identical SPA shell.
  app.use("*", async (req, res, next) => {
    try {
